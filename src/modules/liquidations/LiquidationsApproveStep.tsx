    ...
    <Box>
      <Box sx={{ px: { xs: 4, xsm: 6 }, pt: { xs: 3.5, xsm: 4 }, pb: 2 }}>
        ...
        <Typography variant="description" color="text.secondary">
          <Trans>
            Grant the liquidation router permission to use each selected deposit. This approves the
            interest-bearing token your deposit is held as, so it keeps earning until a liquidation
            actually draws on it. One approval per token.
          </Trans>
        </Typography>
      </Box>
      ...
      <Box sx={{ px: { xs: 4, xsm: 6 }, py: 4 }}>
        <Warning severity="info" sx={{ mb: 0 }}>
          <Trans>
            Approvals only authorize the router to pull up to the shown amount of each token when a
            liquidation executes. Your funds stay in your deposit earning interest until then, and
            an approval alone never moves them.
          </Trans>
        </Warning>
      </Box>
    </Box>
