...
const REENTAL_MARKET_LOGO = '/icons/tokens/reental.svg';
  ...
  return (
    ...
    >
      <object
        ...
        ref={ref}
        id="svg"
        data={getTokenIconSrc(symbol.toLowerCase())}
  ...
  return (
    ...
    >
      ...
      <g id="Group_29109">
        ...
        {symbol && <image x="25" y="25" href={getTokenIconSrc(symbol)} width="206" height="206" />}
      </g>
    </svg>
  );
});
  ...
  return (
    <Icon
      ...
      sx={{
        ...
        borderRadius: '50%',
        overflow: 'hidden',
        // Fallback background so transparent svgs (e.g. the Reental mark) stay visible
        // on both the light and dark header bands, mirroring MarketLogo.
