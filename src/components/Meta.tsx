...
export function Meta({ title, description, imageUrl, timestamp }: MetaProps) {
  return (
    <Head>
      <title>RNT Lend - {title}</title>
      <meta name="description" content={description} key="description" />
      <meta property="og:title" content={`RNT Lend - ${title}`} key="title" />
      ...
      {imageUrl && <meta name="twitter:image:alt" content={`RNT Lend image`} key="twitteralt" />}
      ...
      <meta name="apple-mobile-web-app-title" content={`RNT Lend`} />
